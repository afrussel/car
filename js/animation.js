$(".range-modal-form-btn").click(function () {
 ...
 $(document).ready(function () {
    $(".animsition").animsition({
       ...
       outDuration: 200,
       linkElement: 'a',
       linkElement: 'a:not([target="_blank"]):not([href^="#"]):not([class="link-footer"]):not([class="link-gallery"]):not([class="swiper-slide activate-info-box-gallery swiper-slide-active"]):not([id="bingc-phone-button"]):not([id="bingc-passive-close-button"]):not([id="bingc-active-close-button"])',
       loading: true,
